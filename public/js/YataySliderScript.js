...
// JavaScript Document
	...
	anadiv.onmouseout=function(){slayt_zaman=setInterval(slider,3000);}
	...
	if(pasif!=null){
		...
		var kutu = document.getElementById('slaytsirasi');
    	kutu.getElementsByTagName("li")[aktif].setAttribute("class","aktifLi");
    	
		
	pasif=aktif;
	aktif++;
	}
		var slayt_zaman=setInterval(slider,3000);
